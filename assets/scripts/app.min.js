...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _scriptSkill = __webpack_require__(1);
	
	var _scriptSkill2 = _interopRequireDefault(_scriptSkill);
	
	var _fieldTextarea = __webpack_require__(2);
	...
	// import $ from 'jquery';
	(0, _scriptSkill2.default)();
	(0, _fieldTextarea2.default)();
...
/***/ (function(module, exports) {
	...
	var positions = [2, 150, 375, 768];
	var rangeContainer = document.querySelector('.script-skill__range');
	var meter = rangeContainer.querySelector('.script-skill__meter');
	var value = rangeContainer.querySelector('.script-skill__value');
	
	var getPosition = function getPosition(newPos) {
		return positions.reduce(function (actual, current, i) {
			return Math.abs(newPos - positions[actual]) < Math.abs(newPos - current) ? actual : i;
		}, 0);
	};
	
	var setPosition = function setPosition(i) {
		meter.style.left = positions[i] + 'px';
	};
	
	var getLeftCoords = function getLeftCoords(elem) {
	...
	exports.default = function () {
		...
		meter.onmousedown = function (e) {
			var shiftX = e.pageX - getLeftCoords(meter);
	
			document.onmousemove = function (evt) {
				var newPos = evt.pageX - shiftX - getLeftCoords(rangeContainer);
	
				var rightEdge = rangeContainer.offsetWidth - meter.offsetWidth;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var autosize = function autosize(element) {
		setTimeout(function () {
	...
	exports.default = function () {
		document.addEventListener('DOMContentLoaded', function () {
			...
			[].concat((0, _toConsumableArray3.default)(textareas)).forEach(function (item) {
				item.innerText = item.dataset.value;
				item.removeAttribute('data-value');
				autosize(item);
				item.addEventListener('keydown', function () {
					return autosize(item);
				});
			});
		});
	};
